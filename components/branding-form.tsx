    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="mt-1.5 flex gap-2">
        <input
          ...
          className="h-10 flex-1 rounded-lg border border-input bg-background px-3 text-sm outline-none focus:border-ring focus:ring-2 focus:ring-ring/20"
          required
        />
        ...
        <div className="flex gap-2">
          <form action={uploadSiteLogo}>
            <Label htmlFor="logo-upload" className="cursor-pointer">
              <span className="inline-flex h-8 items-center gap-1.5 rounded-lg border border-input bg-background px-3 text-sm font-medium text-foreground transition-colors hover:bg-accent">
